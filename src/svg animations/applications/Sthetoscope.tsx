      ...
      >
        <motion.g>
          <motion.g>
            ...
            strokeWidth={3}
            strokeLinecap={"round"}
            initial={{pathLength: animateState.pathLengthStart, opacity: animateState.opacityStart}}
            animate={{pathLength: animateState.pathLengthEnd, opacity: animateState.pathLengthEnd}}
            transition={transition}
            />
          </motion.g>
        </motion.g>
